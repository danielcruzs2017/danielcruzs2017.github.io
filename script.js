document.addEventListener('DOMContentLoaded', () => {
    ...
    // Ocultar si la imagen por defecto no existe (para evitar ícono roto)
    previewLogo.addEventListener('error', function() {
        if (this.getAttribute('src') === defaultLogoSrc || this.src.endsWith(defaultLogoSrc)) {
    ...
    logoInput.addEventListener('change', function(e) {
        ...
        if (file) {
            ...
            previewLogo.src = defaultLogoSrc;
            // Si la imagen carga, se remueve hidden en el evento 'load'
        }
    });
