document.addEventListener('DOMContentLoaded', () => {
    ...
    function updateDynamicTexts() {
        ...
        const ribbonEl = document.getElementById('area-ribbon');
        ...
        const areaInitials = {
            ...
            'Arte y Cultura': 'ARTE',
            'Educación Física': 'FISICA',
            'Tutoría': 'TUTO',
            'Educación Religiosa': 'REL'
        };

        if (ribbonEl) {
            ribbonEl.className = 'ribbon'; // reset
            
            if (ribbonTextEl) {
                ribbonTextEl.textContent = areaInitials[area] || '';
            }

            if (area === 'Comunicación') ribbonEl.classList.add('ribbon-comunicacion');
            else if (area === 'Ciencia y Tecnología') ribbonEl.classList.add('ribbon-ciencia');
            else if (area === 'Ciencias Sociales') ribbonEl.classList.add('ribbon-sociales');
            else if (area === 'Desarrollo Personal, Ciudadanía y Cívica') ribbonEl.classList.add('ribbon-dpcc');
            else if (area === 'Inglés') ribbonEl.classList.add('ribbon-ingles');
            else if (area === 'Educación Religiosa') ribbonEl.classList.add('ribbon-religiosa');
            else if (area === 'Educación Física') ribbonEl.classList.add('ribbon-fisica');
            else if (area === 'Educación para el Trabajo') ribbonEl.classList.add('ribbon-ept');
            else if (area === 'Arte y Cultura') ribbonEl.classList.add('ribbon-arte');
            else if (area === 'Matemática') ribbonEl.classList.add('ribbon-matematica');
            else if (area === 'Tutoría') ribbonEl.classList.add('ribbon-tutoria');
            else ribbonEl.classList.add('ribbon-default');
            
            if (!area) ribbonEl.style.display = 'none';
            else ribbonEl.style.display = 'block';
        }
    ...
    btnPdf.addEventListener('click', () => {
        ...
        const opt = {
            ...
            html2canvas:  { scale: 2, useCORS: true, scrollY: 0, windowWidth: 800, width: 800 },
